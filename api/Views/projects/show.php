...
<article class="project-single">
    <div class="project-hero">
        ...
        <aside class="project-sidebar">
            ...
            <div class="card">
                <div class="sidebar-section">
                    <h3 class="sidebar-section-title">Links & Downloads</h3>
                    <div class="resource-list">
                        <?php foreach ($resources as $res): ?>
                            ...
                            <?php elseif ($res['type'] === 'steam'): ?>
                                <a href="https://store.steampowered.com/app/<?= htmlspecialchars($res['app_id']) ?>" target="_blank" class="resource-link">
                            ...
                            <?php elseif ($res['type'] === 'youtube'): ?>
                                <a href="https://youtube.com/watch?v=<?= htmlspecialchars($res['video_id']) ?>" target="_blank" class="resource-link">
                            ...
                            <?php elseif ($res['type'] === 'download'): ?>
                                <a href="<?= htmlspecialchars($res['file_path']) ?>" download class="resource-link">
