        ...
        <section class="dashboard-section" style="margin-top: 24px;">
            <div class="card">
                <div class="card-body" style="text-align: center; padding: 24px;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="var(--accent)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" style="margin-bottom: 12px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
                    <h3 style="font-size: 14px; font-weight: 600; margin-bottom: 8px;">Stay Updated</h3>
                    <p style="font-size: 13px; color: var(--text-secondary); margin-bottom: 16px;">Get notified about new projects and updates.</p>
                    <form method="POST" action="/newsletter/subscribe" style="display: flex; flex-direction: column; gap: 8px;">
                        <?= \Api\Core\View::csrfField() ?>
                        <input type="email" name="email" placeholder="Your email" class="form-input" style="text-align: center;" required>
