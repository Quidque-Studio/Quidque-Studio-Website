...
<div class="editor-page">
    ...
    <form method="POST" action="<?= $devlog ? "/admin/projects/{$project['id']}/devlogs/{$devlog['id']}" : "/admin/projects/{$project['id']}/devlogs" ?>" class="editor-form">
        ...
        <div class="editor-section">
            <div class="editor-section-header">
                ...
                <span class="editor-section-title">Devlog Details</span>
            </div>
            <div class="editor-section-body">
                <div class="editor-hint" style="margin-bottom: 16px;">
                    Project: <strong style="color: var(--text-primary);"><?= htmlspecialchars($project['title']) ?></strong>
                </div>
                <div class="editor-field">
                    <label class="editor-label">Title</label>
                    <input type="text" name="title" class="editor-input" value="<?= htmlspecialchars($devlog['title'] ?? '') ?>" placeholder="Devlog title" required>
                </div>
                <div class="editor-field" style="margin-top: 20px;">
                    <label class="editor-label">Tags <span class="optional">(comma separated)</span></label>
                    <input type="text" name="tags" class="editor-input" value="<?= htmlspecialchars(implode(', ', Str::formatTags($devlog['tags'] ?? null))) ?>" placeholder="update, bugfix, feature">
                </div>
            </div>
        </div>
        ...
        <div class="editor-section">
            <div class="editor-actions">
                <button type="submit" class="btn btn-primary"><?= $devlog ? 'Update Devlog' : 'Create Devlog' ?></button>
